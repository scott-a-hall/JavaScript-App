!(function(e) {
      ...
      ? ((e._handled = !0),
        r._immediateFn(function() {
          ...
          if (null !== t) {
            ...
            f(n.promise, o);
          } else (1 === e._state ? f : u)(n.promise, e._value);
        }))
      : e._deferreds.push(n);
  }
  function f(e, n) {
    try {
      ...
      if (n && ('object' == typeof n || 'function' == typeof n)) {
        var t = n.then;
        if (n instanceof r) return (e._state = 3), (e._value = n), void c(e);
  ...
  (r.prototype.catch = function(e) {
    ...
    (r.prototype.then = function(e, n) {
      ...
      return i(this, new a(e, n, t)), t;
    }),
    (r.prototype.finally = e),
    (r.all = function(e) {
      return new r(function(n, o) {
        if (!t(e)) return o(new TypeError('Promise.all accepts an array'));
    ...
    (r.race = function(e) {
      return new r(function(n, o) {
        ...
        for (var i = 0, f = e.length; i < f; i++) r.resolve(e[i]).then(n, o);
      });
    }),
    (r._immediateFn =
